...
public class PlayerMovement : MonoBehaviour
{
    ...
    public AudioClip mAudioFootStepsConcrete;
    public AudioClip mAudioFootStepsDirt;
    public AudioClip mAudioFootStepsMetal;
    public AudioClip mAudioFootStepsSand;
    public AudioClip mAudioFootStepsWood;
    ...
    public void PlayFootstepSoundConcrete()
    {
       
        footstepAudioSource.PlayOneShot(mAudioFootStepsConcrete);
       
    }
    public void PlayFootstepSoundDirt()
    {

        footstepAudioSource.PlayOneShot(mAudioFootStepsDirt);

    }
    public void PlayFootstepSoundMetal()
    {

        footstepAudioSource.PlayOneShot(mAudioFootStepsMetal);

    }
    public void PlayFootstepSoundSand()
    {

        footstepAudioSource.PlayOneShot(mAudioFootStepsSand);

    }
    public void PlayFootstepSoundWood()
    {

        footstepAudioSource.PlayOneShot(mAudioFootStepsWood);
